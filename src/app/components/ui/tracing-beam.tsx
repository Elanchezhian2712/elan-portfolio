...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute top-3 -right-4 md:-right-20 h-full"> 
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "white" : "#8500ff", 
              borderColor: scrollYProgress.get() > 0 ? "white" : "#8500ff", 
            }}
