      ...
      <SectionWrapper className="pt-24 lg:pt-32">
        <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.8 }} className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center flex-wrap gap-4 mt-6 sm:mt-8">
            <Link href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-medium rounded-full shadow-lg transition-all w-full sm:w-auto text-center">
              <ExternalLink size={20} /> Live Demo
            </Link>
            {project.github && (
              <Link href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-700 to-gray-500 hover:from-gray-600 hover:to-gray-400 text-white font-medium rounded-full shadow-lg transition-all w-full sm:w-auto text-center">
